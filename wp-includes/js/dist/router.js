/******/ (() => {
  ...
  /* harmony default export */ const route_recognizer_es = RouteRecognizer; // ./node_modules/@babel/runtime/helpers/esm/extends.js
  ...
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","url"]
  const external_wp_url_namespaceObject = window["wp"]["url"]; // external ["wp","compose"]
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/router/build-module/router.js
  /* wp:polyfill */
  /**
  ...
  function useHistory() {
    const { pathArg, beforeNavigate } = (0,
    external_wp_element_namespaceObject.useContext)(ConfigContext);
    const navigate = (0, external_wp_compose_namespaceObject.useEvent)(
      async (rawPath, options = {}) => {
        var _getPath;
        const query = (0, external_wp_url_namespaceObject.getQueryArgs)(
          rawPath
        );
        const path =
          (_getPath = (0, external_wp_url_namespaceObject.getPath)(
            "http://domain.com/" + rawPath
          )) !== null && _getPath !== void 0
            ? _getPath
            : "";
        const performPush = () => {
        ...
        await new Promise((resolve) => {
          ...
          const classname =
            (_options$transition = options.transition) !== null &&
            _options$transition !== void 0
              ? _options$transition
              : "";
  ...
  function RouterProvider({
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      ConfigContext.Provider,
      {
        value: config,
        children: /*#__PURE__*/ (0,
        external_ReactJSXRuntime_namespaceObject.jsx)(RoutesContext.Provider, {
          value: match,
          children: children,
        }),
      }
  ...
  function Link({ to, options, children, ...props }) {
  ...
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/router/build-module/lock-unlock.js
  /**
   * WordPress dependencies
   */
