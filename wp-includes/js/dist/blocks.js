/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    */
    ...
    /***/ 5373: /***/ (__unused_webpack_module, exports) => {
      "use strict";
  ...
  (() => {
    ...
    __webpack_require__.d(__webpack_exports__, {
      ...
      __EXPERIMENTAL_PATHS_WITH_OVERRIDE: () =>
        /* reexport */ __EXPERIMENTAL_PATHS_WITH_OVERRIDE,
      __EXPERIMENTAL_STYLE_PROPERTY: () =>
        /* reexport */ __EXPERIMENTAL_STYLE_PROPERTY,
      __experimentalCloneSanitizedBlock: () =>
        /* reexport */ __experimentalCloneSanitizedBlock,
      __experimentalGetAccessibleBlockLabel: () =>
        /* reexport */ getAccessibleBlockLabel,
      __experimentalGetBlockAttributesNamesByRole: () =>
        /* reexport */ __experimentalGetBlockAttributesNamesByRole,
      ...
      getBlockAttributesNamesByRole: () =>
        /* reexport */ getBlockAttributesNamesByRole,
      ...
      getBlockMenuDefaultClassName: () =>
        /* reexport */ getBlockMenuDefaultClassName,
      ...
      registerBlockBindingsSource: () =>
        /* reexport */ registerBlockBindingsSource,
      ...
      setFreeformContentHandlerName: () =>
        /* reexport */ setFreeformContentHandlerName,
      setGroupingBlockName: () => /* reexport */ setGroupingBlockName,
      setUnregisteredTypeHandlerName: () =>
        /* reexport */ setUnregisteredTypeHandlerName,
      store: () => /* reexport */ store,
      switchToBlockType: () => /* reexport */ switchToBlockType,
      synchronizeBlocksWithTemplate: () =>
        /* reexport */ synchronizeBlocksWithTemplate,
      unregisterBlockBindingsSource: () =>
        /* reexport */ unregisterBlockBindingsSource,
      ...
      unstable__bootstrapServerSideBlockDefinitions: () =>
        /* reexport */ unstable__bootstrapServerSideBlockDefinitions,
    ...
    const external_wp_data_namespaceObject = window["wp"]["data"]; // ./node_modules/tslib/tslib.es6.mjs
    /******************************************************************************
...
***************************************************************************** */
    ...
    const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // ./node_modules/colord/index.mjs
    ...
    const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","dom"]
    const external_wp_dom_namespaceObject = window["wp"]["dom"]; // external ["wp","richText"]
    const external_wp_richText_namespaceObject = window["wp"]["richText"]; // external ["wp","deprecated"]
    ...
    const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/blocks/build-module/lock-unlock.js
    /**
    ...
    function unstable__bootstrapServerSideBlockDefinitions(definitions) {
      const { addBootstrappedBlockType } = unlock(
    ...
    const registerBlockBindingsSource = (source) => {
      ...
      if (label && existingSource?.label && label !== existingSource?.label) {
        true
          ? external_wp_warning_default()(
              'Block bindings "' + name + '" source label was overridden.'
            )
          : 0;
      }
    ...
    function unregisterBlockBindingsSource(name) {
      ...
      unlock(
        (0, external_wp_data_namespaceObject.dispatch)(store)
      ).removeBlockBindingsSource(name);
    }
    ...
    function isUnmodifiedBlock(block) {
      ...
      return Object.entries(
        (_getBlockType$attribu = getBlockType(block.name)?.attributes) !==
          null && _getBlockType$attribu !== void 0
          ? _getBlockType$attribu
          : {}
    ...
    function blockStyles(state = {}, action) {
      ...
      switch (action.type) {
                ...
                ([name, blockType]) => {
                  ...
                  return [
                    ...
                    getUniqueItemsByName([
                      ...((_blockType$styles = blockType.styles) !== null &&
                      _blockType$styles !== void 0
                        ? _blockType$styles
                        : []
                      ).map((style) => ({
                        ...style,
                      ...
                      ...((_state$blockType$name = state[blockType.name]) !==
                        null && _state$blockType$name !== void 0
                        ? _state$blockType$name
                        : []
                      ).filter(({ source }) => "block" !== source),
                    ]),
                  ];
                }
              )
        ...
        case "ADD_BLOCK_STYLES":
          ...
          action.blockNames.forEach((blockName) => {
            ...
            updatedStyles[blockName] = getUniqueItemsByName([
              ...((_state$blockName = state[blockName]) !== null &&
              _state$blockName !== void 0
                ? _state$blockName
                : []),
              ...action.styles,
            ]);
        ...
        case "REMOVE_BLOCK_STYLES":
          return {
            ...state,
            [action.blockName]: ((_state$action$blockNa =
              state[action.blockName]) !== null &&
            _state$action$blockNa !== void 0
              ? _state$action$blockNa
              : []
    ...
    function blockVariations(state = {}, action) {
      ...
      switch (action.type) {
              ...
              Object.entries(keyBlockTypesByName(action.blockTypes)).map(
                ([name, blockType]) => {
                  ...
                  return [
                    name,
                    getUniqueItemsByName([
                      ...((_blockType$variations = blockType.variations) !==
                        null && _blockType$variations !== void 0
                        ? _blockType$variations
                        : []
                      ).map((variation) => ({
                        ...variation,
                        source: "block",
                      })),
                      ...((_state$blockType$name2 = state[blockType.name]) !==
                        null && _state$blockType$name2 !== void 0
                        ? _state$blockType$name2
                        : []
                      ).filter(({ source }) => "block" !== source),
                    ]),
                  ];
        ...
        case "ADD_BLOCK_VARIATIONS":
          return {
            ...
            [action.blockName]: getUniqueItemsByName([
              ...((_state$action$blockNa2 = state[action.blockName]) !== null &&
              _state$action$blockNa2 !== void 0
                ? _state$action$blockNa2
                : []),
              ...action.variations,
            ]),
          };
        case "REMOVE_BLOCK_VARIATIONS":
          return {
            ...state,
            [action.blockName]: ((_state$action$blockNa3 =
              state[action.blockName]) !== null &&
            _state$action$blockNa3 !== void 0
              ? _state$action$blockNa3
              : []
            ).filter(
              (variation) =>
    ...
    var remove_accents_default =
      /*#__PURE__*/ __webpack_require__.n(remove_accents); // ./node_modules/@wordpress/blocks/build-module/store/utils.js
    /**
    ...
    function matchesAttributes(blockAttributes, variationAttributes) {
      if (
        utils_isObject(blockAttributes) &&
        utils_isObject(variationAttributes)
      ) {
      ...
      (state, name, element) => {
        ...
        Object.keys(__EXPERIMENTAL_STYLE_PROPERTY).forEach((styleName) => {
          ...
          if (__EXPERIMENTAL_STYLE_PROPERTY[styleName].requiresOptOut) {
            if (
              __EXPERIMENTAL_STYLE_PROPERTY[styleName].support[0] in
                blockType.supports &&
     ...
     */
    const selectors_getBlockTypes = (0,
    external_wp_data_namespaceObject.createSelector)(
     ...
     * @return {(WPBlockVariation[]|void)} Block variations.
     */
    const selectors_getBlockVariations = (0,
    external_wp_data_namespaceObject.createSelector)(
      ...
      for (const variation of variations) {
        if (Array.isArray(variation.isActive)) {
          ...
          const isMatch = definedAttributes.every((attribute) => {
            ...
            if (
              blockAttributeValue instanceof
              external_wp_richText_namespaceObject.RichTextData
            ) {
     ...
     * @return {Array} Array of child block names.
     */
    const selectors_getChildBlockNames = (0,
    external_wp_data_namespaceObject.createSelector)(
      (state, blockName) => {
    ...
    var react_is = __webpack_require__(8529); // external ["wp","hooks"]
    const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // ./node_modules/@wordpress/blocks/build-module/store/process-block-type.js
    /**
     * External dependencies
     */
    ...
    const processBlockType =
      ...
      ({ select }) => {
        ...
        if (
          "edit" in settings &&
          !(0, react_is.isValidElementType)(settings.edit)
        ) {
          true
            ? external_wp_warning_default()(
        ...
        if (
          ...
          !select.getCategories().some(({ slug }) => slug === settings.category)
        ) {
          true
            ? external_wp_warning_default()(
                'The block "' +
    ...
    const STORE_NAME = "core/blocks"; // ./node_modules/@wordpress/blocks/build-module/store/index.js
    ...
    unlock(store).registerPrivateActions(private_actions_namespaceObject); // ./node_modules/@wordpress/blocks/node_modules/uuid/dist/esm-browser/native.js
    ...
    /* harmony default export */ const esm_browser_stringify =
      /* unused pure expression or super */ null && stringify; // ./node_modules/@wordpress/blocks/node_modules/uuid/dist/esm-browser/v4.js
    ...
    /* harmony default export */ const esm_browser_v4 = v4; // ./node_modules/@wordpress/blocks/build-module/api/factory.js
    /**
     * External dependencies
     */
    ...
    function switchToBlockType(blocks, name) {
      ...
      const transformation =
        findTransform(
          ...
          (t) =>
            t.type === "block" &&
            (isWildcardBlockTransform(t) || t.blocks.indexOf(name) !== -1) &&
    ...
    const external_wp_blockSerializationDefaultParser_namespaceObject =
      window["wp"]["blockSerializationDefaultParser"]; // external ["wp","autop"]
    const external_wp_autop_namespaceObject = window["wp"]["autop"]; // external ["wp","isShallowEqual"]
    ...
    const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/blocks/build-module/api/serializer.js
    /**
     * WordPress dependencies
     */
    ...
    function getCommentAttributes(blockType, attributes) {
      ...
      return Object.entries(
        (_blockType$attributes = blockType.attributes) !== null &&
          ...
          : {}
      ).reduce((accumulator, [key, attributeSchema]) => {
        const value = attributes[key];
        ...
        if (
          ...
          JSON.stringify(attributeSchema.default) === JSON.stringify(value)
        ) {
          return accumulator;
        }
    ...
    var es6_default = /*#__PURE__*/ __webpack_require__.n(es6); // external ["wp","htmlEntities"]
    const external_wp_htmlEntities_namespaceObject =
      window["wp"]["htmlEntities"]; // ./node_modules/@wordpress/blocks/build-module/api/validation/logger.js
    /**
     * @typedef LoggerItem
     ...
     */
    function isEqualTagAttributePairs(
      actual,
      expected,
      logger = createLogger()
    ) {
    ...
    function convertLegacyBlockNameAndAttributes(name, attributes) {
      ...
      if (name && name.indexOf("core-embed/") === 0) {
        ...
        newAttributes.providerNameSlug =
          providerSlug in deprecated ? deprecated[providerSlug] : providerSlug;
    ...
    const richText = (selector, preserveWhiteSpace) => (el) => {
      ...
      return target
        ? external_wp_richText_namespaceObject.RichTextData.fromHTMLElement(
            target,
            {
              preserveWhiteSpace,
            }
     ...
     */
    const toBooleanAttributeMatcher = (matcher) => (value) =>
      ...
      switch (sourceConfig.source) {
        ...
        case "query":
          const subMatchers = Object.fromEntries(
            Object.entries(sourceConfig.query).map(([key, subSourceConfig]) => [
              key,
      ...
      while (decu.firstChild) {
        ...
        if (node.nodeType === node.TEXT_NODE) {
          ...
          if (node.nodeName === "BR") {
            ...
            if (
              (0, external_wp_dom_namespaceObject.isEmpty)(node) &&
              !options.raw
            ) {
              decu.removeChild(node);
            } else {
    ...
    function isFigureContent(node, schema) {
      ...
      return (
        tag in
        ((_schema$figure$childr = schema?.figure?.children) !== null &&
    ...
    function canHaveAnchor(node, schema) {
      ...
      return (
        tag in
        ((_schema$figure$childr2 = schema?.figure?.children?.a?.children) !==
          null && _schema$figure$childr2 !== void 0
    ...
    const external_wp_shortcode_namespaceObject = window["wp"]["shortcode"]; // ./node_modules/@wordpress/blocks/build-module/api/raw-handling/shortcode-converter.js
    /**
     * WordPress dependencies
     */
    ...
    function segmentHTMLToShortcodeBlock(
      ...
      if (
        ...
        if (
          ...
          !(
            beforeLineRegexp.test(beforeHTML) && afterLineRegexp.test(afterHTML)
          )
        ) {
    ...
    /* harmony default export */ const shortcode_converter =
      segmentHTMLToShortcodeBlock; // ./node_modules/@wordpress/blocks/build-module/api/raw-handling/utils.js
    ...
    function rawHandler({ HTML = "" }) {
      ...
      if (HTML.indexOf("<!-- wp:") !== -1) {
        ...
        const isSingleFreeFormBlock =
          parseResult.length === 1 && parseResult[0].name === "core/freeform";
    ...
    const external_wp_blob_namespaceObject = window["wp"]["blob"]; // ./node_modules/@wordpress/blocks/build-module/api/raw-handling/image-corrector.js
    /* wp:polyfill */
    /**
     * WordPress dependencies
     */
    ...
    var showdown_default = /*#__PURE__*/ __webpack_require__.n(showdown); // ./node_modules/@wordpress/blocks/build-module/api/raw-handling/markdown-converter.js
    /**
     * External dependencies
     */
