( () => {
			...
			93: () => {
				const e = window.wp.blocks,
					...
					i = ( { heading: e, features: t = [] } ) =>
						( 0, r.jsx )( 'section', {
							className:
								'not-prose section-padding w-full bg-brand-grey',
							children: ( 0, r.jsxs )( 'div', {
								...
								children: [
									e &&
										( 0, r.jsx )( 'h2', {
											className:
												'!my-0  !text-3xl md:!text-4xl lg:!text-5xl !font-[600] !text-brand-dark-blue text-left lg:max-w-[60%]',
											children: e,
										} ),
									( 0, r.jsx )( 'div', {
										className:
											...
											return ( 0, r.jsxs )(
												'div',
												{
													...
													children: [
														...
														( 0, r.jsxs )( 'div', {
															className:
																'w-full lg:w-1/2 text-brand-dark-blue',
															children: [
																( 0, r.jsx )(
																	'h3',
																	{
	...
	( l.m = t ),
		...
		( l.O = ( t, a, r, i ) => {
			...
			i = i || 0;
			for ( var x = e.length; x > 0 && e[ x - 1 ][ 2 ] > i; x-- )
				e[ x ] = e[ x - 1 ];
			e[ x ] = [ a, r, i ];
		} ),
