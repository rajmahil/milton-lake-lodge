			...
			122: ( e, t, r ) => {
				...
				const s = window.ReactJSXRuntime,
					a = ( {
						...
						( 0, s.jsxs )( 'section', {
							className:
								'h-screen flex items-end  overflow-hidden relative not-prose section-padding w-full static-background',
							children: [
								( 0, s.jsx )( 'div', {
									className:
									...
									children: [
										( 0, s.jsxs )( 'div', {
											...
											children: [
												...
												( 0, s.jsx )( 'h1', {
													className:
														'!my-0 !text-4xl md:!text-5xl lg:!text-6xl !font-[600]  text-left ',
													children: t,
												} ),
												( 0, s.jsx )( 'p', {
													className:
														'!my-0 text-xl  text-left !leading-normal',
													children: r,
												} ),
											],
										} ),
