		...
		t = {
			122: ( e, t, r ) => {
				...
				const n = window.wp.blocks,
					o = ( window.wp.element, window.wp.i18n ),
				...
				const s = window.ReactJSXRuntime,
					a = ( {
						...
						( 0, s.jsxs )( 'section', {
							className:
								'h-screen flex items-end  overflow-hidden relative not-prose section-padding w-full',
							children: [
								( 0, s.jsx )( 'div', {
									className:
									...
									children: ( 0, s.jsx )( 'img', {
										src:
											...
											a?.url ||
											'/placeholder.svg',
										srcSet: `\n    ${ a?.sizes?.thumbnail?.url } 150w,\n    ${ a?.sizes?.medium?.url } 300w,\n    ${ a?.sizes?.large?.url } 1024w,\n    ${ a?.sizes?.full?.url } ${ a?.width }w\n  `,
								...
								( 0, s.jsx )( 'div', {
									className:
										'absolute bottom-0 left-0 w-full h-full bg-linear-to-t  from-brand-dark-blue to-black/0',
								} ),
								( 0, s.jsxs )( 'div', {
									className:
										'relative z-[2] max-w-container flex flex-row gap-5 flex-wrap items-center justify-between ',
									children: [
										( 0, s.jsxs )( 'div', {
											className:
												'flex flex-col gap-4 max-w-[650px] w-full',
											children: [
												( 0, s.jsx )( 'p', {
													className:
												...
												( 0, s.jsx )( 'h1', {
													className:
														'!my-0 !text-4xl md:!text-5xl lg:!text-6xl !font-[600] !text-white text-left ',
													children: t,
												} ),
												( 0, s.jsx )( 'p', {
													className:
														'!my-0 text-xl !text-white text-left !leading-normal',
													children: r,
												} ),
											],
										} ),
					...
					u = JSON.parse( '{"UU":"brad-boilerplate/hero-section"}' );
				( 0, n.registerBlockType )( u.UU, {
					edit: function ( { attributes: e, setAttributes: t } ) {
						...
						return ( 0, s.jsxs )( 'div', {
							...b,
							children: [
								( 0, s.jsxs )( i.InspectorControls, {
									children: [
										( 0, s.jsxs )( l.PanelBody, {
											title: ( 0, o.__ )(
												'Content',
												'your-text-domain'
											),
											children: [
												( 0, s.jsx )( l.TextControl, {
													label: ( 0, o.__ )(
														'Top Heading',
														'your-text-domain'
													),
										...
										},
										{
											...
											value: function () {
												...
												var e = this.props,
													...
													r = e.threshold,
													n =
														this.getPlaceholderBoundingBox(
															t
														),
													o =
														t.y +
								...
								function u( e ) {
									...
									if (
										...
										( ( r = a.call(
											...
											e.useIntersectionObserver && l() ),
										r.useIntersectionObserver )
									)
										return E( r );
									var n = r.onChangeScroll.bind( k( r ) );
									return (
	...
	( n.m = t ),
		...
		( n.O = ( t, r, o, i ) => {
			if ( ! r ) {
				...
				for ( c = 0; c < e.length; c++ ) {
					for (
						var [ r, o, i ] = e[ c ], s = ! 0, a = 0;
						a < r.length;
						a++
					)
						( ! 1 & i || l >= i ) &&
						Object.keys( n.O ).every( ( e ) => n.O[ e ]( r[ a ] ) )
							? r.splice( a--, 1 )
							: ( ( s = ! 1 ), i < l && ( l = i ) );
					if ( s ) {
						e.splice( c--, 1 );
		...
		( () => {
			...
			var t = ( t, r ) => {
				...
				r = ( globalThis.webpackChunkmy_first_block =
					globalThis.webpackChunkmy_first_block || [] );
			r.forEach( t.bind( null, 0 ) ),
				( r.push = t.bind( null, r.push.bind( r ) ) );
		} )();
	var o = n.O( void 0, [ 448 ], () => n( 122 ) );
	o = n.O( o );
} )();
