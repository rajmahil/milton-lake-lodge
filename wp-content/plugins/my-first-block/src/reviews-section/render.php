      ...
      <?php foreach ($reviews as $i => $review): ?>
        <?php if (!empty($review['image1']['url'])): ?>
          <div
            ...
            class="image-left w-full aspect-[3/4] max-w-[190px] sm:max-w-[230px] md:max-w-[270px] lg:max-w-[350px] absolute z-0 translate-x-0 translate-y-2 scale-90 rotate-0"
          >
            <img src="<?php echo esc_url($review['image1']['url']); ?>" alt="Review image 1" class="w-full h-full object-cover" />
          </div>
        <?php endif; ?>
        ...
        <?php if (!empty($review['image2']['url'])): ?>
          <div
            ...
            x-show="currentIndex === <?php echo $i; ?>"
            class="image-right w-full aspect-[3/4] max-w-[190px] sm:max-w-[230px] md:max-w-[270px] lg:max-w-[350px] absolute z-10 translate-x-0 translate-y-2 scale-90 rotate-0"
          >
            <img src="<?php echo esc_url($review['image2']['url']); ?>" alt="Review image 2" class="w-full h-full object-cover" />
          </div>
        <?php endif; ?>
      <?php endforeach; ?>
    </div>
