  ...
  <div class="max-w-container mx-auto grid lg:grid-cols-2 items-center justify-center gap-10">
    <div class="relative min-h-[300px] sm:min-h-[400px] w-full flex items-center justify-center">
      ...
      <div
        ...
        class="image-left w-full aspect-[3/4] max-w-[190px] sm:max-w-[230px] md:max-w-[270px] lg:max-w-[400px] z-0 translate-x-0 translate-y-2 rotate-0"
      >
      ...
      <div
        ...
        x-show="currentIndex === <?php echo $i; ?>"
        class="image-right w-full aspect-[3/4] max-w-[190px] sm:max-w-[230px] md:max-w-[270px] lg:max-w-[400px] absolute z-10 translate-x-0 translate-y-2 rotate-0"
      >
        <?php
