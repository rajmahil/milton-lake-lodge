...
<section class="not-prose section-padding w-full static-background" <?php echo get_block_wrapper_attributes(); ?>>
    <div class="max-w-container mx-auto flex flex-col gap-8">
        ...
        <h2 class="!my-0 text-center !text-4xl 750:!text-5xl font-extrabold uppercase text-[#123C2A]">
                    ...
                    <?php foreach ($tabs as $index => $tab): ?>
                        ...
                        >
                            <div class=" 750:grid 750:grid-cols-2 py-6 px-8 !text-base !text-gray-800 1000:gap-10">
                                ...
                                <div class="flex items-center gap-10" x-data="{ currency: 'CAD' }">
                            ...
                            <?php if (!empty($tab['note'])): ?>
                                <div class="border-t border-brand-grey p-8 text-gray-800">
                                    <p class="!text-sm">
