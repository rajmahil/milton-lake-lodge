 ...
 * Now with image counter functionality
 */
    ...
    <div 
        ...
        x-data="{
            ...
            updateActiveImage() {
                ...
                this.imageGalleryActiveUrl = images[this.imageGalleryImageIndex].src;
            }
        }" 
                        ...
                        <div class="flex flex-col md:flex-row gap-2 sm:gap-4">
                            <?php if (!empty($groupImages[0]['url'])) : ?>
                                <div class="flex-1 aspect-[3/2] relative overflow-hidden rounded-xl">
                                    <img 
                                        src="<?php echo esc_url($groupImages[0]['url']); ?>"
                                        alt="<?php echo esc_attr($groupImages[0]['alt'] ?? ''); ?>"
            ...
            >
                <div class="relative flex items-center justify-center w-11/12 xl:w-4/5 h-11/12"> 
                    ...
                    <div class="relative flex items-center justify-center w-full h-full">
                        ...
                        <!-- Image counter -->
                        <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-black/90 text-white py-1 px-4 rounded-full text-sm font-medium">
