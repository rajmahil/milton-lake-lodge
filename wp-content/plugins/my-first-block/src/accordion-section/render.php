...
<section class="not-prose section-padding w-full static-background">
  ...
  >
    ...
    <div class="relative w-full overflow-hidden flex flex-col gap-5">
      ...
      <div
        class="accordion-item !cursor-pointer group bg-white rounded-xl p-4 transition-all duration-200 ease-in-out "
      ...
      >
        ...
        >
          <p class="text-lg font-normal pr-4"><?php echo esc_html($item['title'] ?? ''); ?></p>
          <svg
        ...
        <div
          class="accordion-content text-base text-muted-foreground"
