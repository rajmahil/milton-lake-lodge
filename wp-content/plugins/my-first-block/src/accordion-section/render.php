...
<section class="not-prose section-padding w-full static-background">
  <div class="max-w-container mx-auto grid lg:grid-cols-2 gap-10 items-start" x-data="{ activeAccordion: null }">
    ...
    <div class="relative w-full overflow-hidden flex flex-col gap-5">
      <?php foreach ( $items as $index => $item ): ?>
        ...
        <div class="!cursor-pointer group !bg-white rounded-xl p-4"   
