            ...
            <section class="container mx-auto py-12">
                <div class="max-w-(--breakpoint-md)">
                    ...
                    <div class="[&_a]:text-primary">
                        <h1 class="leading-tight text-3xl md:text-2xl font-medium tracking-tight text-balance text-red-500 ">
                            Rapidly build your next WordPress theme with Tailwind CS
                        </h1>
