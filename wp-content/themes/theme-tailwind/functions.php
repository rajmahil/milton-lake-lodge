...
add_action('after_setup_theme', function () {
    ...
    if (!defined('WP_REDIS_HOST')) {
        ...
        // Debug log to confirm these are being set
        error_log('Redis constants defined in functions.php');
        error_log('WP_REDIS_HOST: ' . WP_REDIS_HOST);
    }

    if (!defined('EXCHANGE_RATE_API_KEY')) {
        define('EXCHANGE_RATE_API_KEY', '7128e4810a5d0bca289f546c');
        error_log('EXCHANGE_RATE_API_KEY defined in functions.php');
    }
});
