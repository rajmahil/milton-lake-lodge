...
>
  ...
  <div
    ...
    :class="{
        ...
        <?php if ($enable_dark_mode): ?> 'bg-brand-green-dark shadow-lg ring-1 ring-black/5': true
        <?php else: ?> 'bg-brand-green-dark/50 backdrop-blur-xl shadow-lg ring-1 ring-black/5': isScrolled,
